...
#ifndef SCHROOT_CUSTOM_ERROR_TCC
#define SCHROOT_CUSTOM_ERROR_TCC
...
inline std::string
schroot::error<T>::format_error (A const&   context1,
                                 B const&   context2,
                                 C const&   context3,
                                 error_type error,
                                 D const&   detail1,
...
template<typename T>
inline void
schroot::error<T>::add_detail(boost::format&        fmt,
...
template <typename A, typename B, typename C, typename R,
          typename D, typename E, typename F>
inline std::string
schroot::error<T>::format_reason (A const&   context1,
                                  B const&   context2,
                                  C const&   context3,
                                  R const&   error,
                                  D const&   detail1,
...
template<typename A>
inline void
schroot::error<T>::add_reason(std::string& reason,
                              A const&     value)
{
...
template <typename T>
inline const char *
schroot::error<T>::get_error (error_type error)
{
...
#endif /* SCHROOT_CUSTOM_ERROR_TCC */
