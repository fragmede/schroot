...
#ifndef SCHROOT_I18N_H
#define SCHROOT_I18N_H

#include <schroot/config.h>

#include <string>

#ifdef SCHROOT_FEATURE_NLS
# include <libintl.h>
#endif // SCHROOT_FEATURE_NLS
...
namespace schroot
{
  ...
  {
#ifdef SCHROOT_FEATURE_NLS
    return ::dgettext (SCHROOT_MESSAGE_CATALOGUE, message);
#else
    return message;
#endif // SCHROOT_FEATURE_NLS
  }
