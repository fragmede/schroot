...
namespace schroot
{
  ...
  error<ctty_error_code>::error_strings =
    {
      {schroot::CTTY_CLOEXEC, N_("The controlling terminal close-on-execute flag could not be set")},
      {schroot::CTTY_DUP,     N_("The controlling terminal file descriptor could not be duplicated")}
    };
