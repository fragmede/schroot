...
namespace sbuild
{
  ...
  template<>
  error<bin::schroot_common::main::error_code>::map_type
  error<bin::schroot_common::main::error_code>::error_strings =
    {
      // TRANSLATORS: %4% = file
      {bin::schroot_common::main::CHROOT_FILE,       N_("No chroots are defined in ‘%4%’")},
      // TRANSLATORS: %4% = file
      // TRANSLATORS: %5% = file
      {bin::schroot_common::main::CHROOT_FILE2,      N_("No chroots are defined in ‘%4%’ or ‘%5%’")},
      // TRANSLATORS: %1% = file
      {bin::schroot_common::main::CHROOT_NOTDEFINED, N_("The specified chroots are not defined in ‘%1%’")},
      {bin::schroot_common::main::SESSION_INVALID,   N_("%1%: Invalid session name")}
    };
